...
DATA_BUCKET_NAME = os.getenv("TRAINING_DATA_BUCKET_NAME", "training")
MODEL_BUCKET_NAME = os.getenv("MODEL_BUCKET_NAME", "models")
...
def extract_data(training_data_filename):
    response = get_minio_client().get_object(DATA_BUCKET_NAME, training_data_filename)
